% !TeX document-id = {1b6f327f-e1a6-4806-9e7c-f47370a628ea}
...
% !TeX TXS-program:compile = txs:///xelatex/[-synctex=15 -output-directory=output -shell-escape]

\documentclass[bibliography=totoc]{mpaper}
